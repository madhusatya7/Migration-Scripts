...
if len(account_payment)>0:
    for rec in range(0,len(account_payment)):
        ...
        values = {'old_id':record_ID, 'name':name18, 'payment_type':payment_type18,'partner_type':partner_type18,'payment_method_id':payment_method_id18 ,'payment_method_line_id':payment_method_line_id18,'currency_id':currency_id18, 'partner_id':partner_id18, 'amount':amount18, 'memo':communication18, 'date':payment_date18, 'company_id':company_id18,'journal_id':journal_id18 }
