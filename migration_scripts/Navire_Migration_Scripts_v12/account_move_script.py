...
if len(account_move)>0:
    for rec in range(0,len(account_move)):
        ...
        create_vals = {'old_id1':record_ID,'auto_post': 'no','date': date18,'move_type':'entry','name':name18,'ref':ref18,'date':date18,'currency_id':currency_id18,'journal_id':journal_id18,'company_id':company_id18,'narration':narration18}
