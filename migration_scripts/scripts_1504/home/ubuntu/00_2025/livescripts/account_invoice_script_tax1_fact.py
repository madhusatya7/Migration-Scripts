...
#('date_invoice','>=','2025-04-08'),('date_invoice','<=','2025-04-09')
#main domain
account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('type','!=','out_refund'),('journal_id','not in',[266,11]),('state','not in',['draft','cancel']),('create_date','>=','2025-04-01'),('date_invoice','>=','2025-03-01'),('date_invoice','<=','2025-03-31'),('company_id','=',2)]],{'order': 'id DESC'})
