...
#account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('id','=',[185932,186597])]],{'order': 'id DESC'})


#main
account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('journal_id','in',[10,262]),('type','=','out_refund'),('state','not in',['draft','cancel']),('create_date','>=','2025-04-01'),('date_invoice','>=','2025-03-01'),('date_invoice','<=','2025-03-31'),('company_id','=',2)]],{'order': 'id DESC'})

#domain = [('id','=',[184677,184198])]
...
####################
#account_invoice = account_invoice[27:]
