...
domain = [('payment_date','>=','2024-01-01'),('payment_date','<=','2024-01-31'),('payment_type','!=','transfer'),('state','not in',['draft','cancelled']),('company_id','=',2)]
...
if len(account_payment)>0:
    for rec in range(0,len(account_payment)):
        ...
        amount18 = int(account_payment_rec[0]['amount'])
