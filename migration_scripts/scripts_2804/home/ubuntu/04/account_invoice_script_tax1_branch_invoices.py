...
#domain = [('id','in',[176366])]
domain = [('state','not in',['draft','cancel']),('journal_id','=',42),('type','=','out_invoice'),('date_invoice','>=','2025-01-01'),('date_invoice','<=','2025-02-16'),('company_id','=',6)]
    ...
    for rec in range(0,len(account_invoice)):
        ...
        if not rec_is_exitst:
            ...
            if state18 in ['open','in_payment','paid']:
                ...
                cogs_mapped_idv18 = 3808 #v18
                stock_outputv18 = 3755 #v18
                acc_recvbl18 = 3697
                acc_payble18 = 3697
                vansal_tax_act18 =3697  # taxreceivable

                cogs_mapped_idv12 = 1033  #direct v12
                stock_outputv12 = 5863 # direct v12
                acc_recbl12 = 933 #direct v12
                acc_payble12 = 933
                
                vansal_tax_act12 = 933

                rpl_tax = 3697 # Tota sale account to chaged because details chaged,Modification applied
