...
domain = [('date','>=','2024-07-01'),('date','<=','2024-12-31'),('state','in',['posted']),('company_id','=',23),('journal_id','not in', ej_278)]
...
##############################
account_move = account_move[5000:]
account_move = account_move[21500:]
