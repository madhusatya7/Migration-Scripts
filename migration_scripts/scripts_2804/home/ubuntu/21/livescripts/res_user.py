...
res_users = sock.execute_kw(dbname, uid, pwd, 'res.users', 'search', [[]])
    ...
    for rec in range(0,len(res_users)):
       ...
       # m2O fields
        ...
        create_vals = {'old_id':record_ID,'password':'1234','login':login18,'name':name18,'tz':tz18,'lang':lang18,
					   'company_id':company_id18,'company_ids':company_ids18,'partner_id':partner_id18}
