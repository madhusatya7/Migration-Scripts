...
account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('journal_id','in',[10,262]),('type','=','out_refund'),('state','not in',['draft','cancel']),('date_invoice','>=','2024-03-01'),('date_invoice','<=','2024-06-30'),('company_id','=',2)]],{'order': 'id DESC'})
# account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('date_invoice','>=','2024-01-01'),('company_id','=',5)]],{'order': 'id DESC'})
