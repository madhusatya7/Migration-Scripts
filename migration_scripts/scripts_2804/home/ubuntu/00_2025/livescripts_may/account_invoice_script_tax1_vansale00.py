...
#main
#account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('type','!=','out_refund'),('state','not in',['draft','cancel']),('date_invoice','>=','2025-04-09'),('date_invoice','<=','2025-04-20'),('company_id','=',2),('journal_id','=',266)]],{'order': 'id DESC'})

account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('type','!=','out_refund'),('state','not in',['draft','cancel']),('create_date','>=','2025-04-01 00:00:00'),('company_id','=',2),('journal_id','=',266)]],{'order': 'id DESC'})

#domain = [('id','=',[177534,177598])]
...
#account_invoice = account_invoice[70:]
