...
domain = [('create_date','>=','2025-04-01 00:00:00'),('date','>=','2025-01-01'),('date','<=','2025-04-20'),('state','in',['posted']),('company_id','=',2),('journal_id','not in', ej_15)]
