...
#('date_invoice','>=','2025-04-09'),('date_invoice','<=','2025-04-20')
#main domain
account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('type','!=','out_refund'),('journal_id','not in',[266,11]),('state','not in',['draft','cancel']),('create_date','>=','2025-04-01 00:00:00'),('date_invoice','>=','2025-01-01'),('date_invoice','<=','2025-04-20'),('company_id','=',2)]],{'order': 'id DESC'})


#account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('id','=',[187068])]],{'order': 'id DESC'})
...
####################
#account_invoice = account_invoice[5000:]
#account_invoice = account_invoice[50:]
#account_invoice = account_invoice[40:]


#account_invoice = account_invoice[120:]
