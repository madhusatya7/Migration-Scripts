...
account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('type','!=','out_refund'),('state','not in',['draft','cancel']),('date_invoice','>=','2025-01-20'),('date_invoice','<=','2025-01-27'),('company_id','=',2),('journal_id','=',266)]],{'order': 'id DESC'})
