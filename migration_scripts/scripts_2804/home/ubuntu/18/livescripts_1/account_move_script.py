...
domain = [('date','>=','2024-07-01'),('date','<=','2024-12-31'),('state','in',['posted']),('company_id','=',20),('journal_id','not in', ej_159)]
...
##############################
account_move = account_move[11800:]
account_move = account_move[450:]
