...
account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('type','!=','out_refund'),('state','not in',['draft','cancel']),('date_invoice','>=','2024-11-01'),('date_invoice','<=','2024-11-30'),('company_id','=',2),('journal_id','=',266)]],{'order': 'id DESC'})
