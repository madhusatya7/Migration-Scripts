...
account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('type','!=','out_refund'),('journal_id','!=',266),('state','not in',['draft','cancel']),('date_invoice','>=','2024-02-01'),('date_invoice','<=','2024-02-29'),('company_id','=',2)]],{'order': 'id DESC'})
...
####################
account_invoice = account_invoice[1150:]
account_invoice = account_invoice[220:] 
account_invoice = account_invoice[350:] 
account_invoice = account_invoice[185:] 
account_invoice = account_invoice[785:] 
account_invoice = account_invoice[550:]
