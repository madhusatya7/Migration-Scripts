...
account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('type','!=','out_refund'),('state','not in',['draft','cancel']),('date_invoice','>=','2024-02-01'),('date_invoice','<=','2024-02-29'),('company_id','=',2),('journal_id','=',266)]],{'order': 'id DESC'})
...
####################
account_invoice = account_invoice[850:]
