...
domain = [('date','>=','2025-01-01'),('date','<=','2025-02-17'),('state','in',['posted']),('company_id','=',22),('journal_id','not in', ej_175)]
...
##############################
#account_move = account_move[29400:]
#account_move = account_move[900:]
