...
account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('type','!=','out_refund'),('journal_id','!=',266),('state','not in',['draft','cancel']),('date_invoice','>=','2024-01-01'),('date_invoice','<=','2024-01-31'),('company_id','=',2)]],{'order': 'id DESC'})
...
####################
account_invoice = account_invoice[1400:]
