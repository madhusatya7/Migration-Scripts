...
res_partner = sock.execute_kw(dbname, uid, pwd, 'res.partner', 'search', [[('create_date','>=','2025-03-01')]])
...
if len(res_partner)>0:
    for rec in range(0,len(res_partner)):
        res_rec = sock.execute_kw(dbname, uid, pwd, 'res.partner', 'search_read',[[('id', '=', res_partner[rec])]], {
												'fields': ['company_type','name','image','street','street2','city','vat','function','phone','mobile',
        ...
        rp_rec_is_exist = sock18.execute_kw(dbname18, uid18, pwd18, 'res.partner', 'search_read',
                                                            [[('company_type','=',company_type18),('name', '=', name18),('street','=',street18),('street2','=',street218),('city','=',city18),('phone','=',phone18),('mobile','=',mobile18),('vat','=',vat18)]], {'fields': ['id','old_id']})
