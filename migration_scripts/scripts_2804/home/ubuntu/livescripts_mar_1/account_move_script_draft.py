...
#domain = [('move_type','!=','out_refund'),('date','>=','2024-03-01'),('date','<=','2024-03-31'),('journal_id','=',174),('company_id','=',26),('state','in',['posted','cancel'])]
domain = [('move_type','!=','out_refund'),('date','>=','2024-03-01'),('date','<=','2024-03-31'),('journal_id','=',174),('company_id','=',26),('state','in',['draft'])]
