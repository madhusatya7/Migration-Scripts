...
# domain = [('id','in',[102108])]
domain = [('state','not in',['draft','cancel']),('journal_id','=',91),('company_id','=',12),('date_invoice','>=','2025-01-01'),('date_invoice','<=','2025-02-16')]
...
####################
#account_invoice = account_invoice[60:]
#account_invoice = account_invoice[55:]
