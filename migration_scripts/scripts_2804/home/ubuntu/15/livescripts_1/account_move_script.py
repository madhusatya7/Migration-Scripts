...
domain = [('date','>=','2024-07-01'),('date','<=','2024-12-31'),('state','in',['posted']),('company_id','=',17),('journal_id','not in', ej_135)]
...
##############################
account_move = account_move[2800:]
account_move = account_move[20650:]
