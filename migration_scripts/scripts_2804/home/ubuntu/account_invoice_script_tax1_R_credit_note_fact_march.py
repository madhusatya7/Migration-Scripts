...
# domain = [('id','in',[117749])]
#domain = [('journal_id','=', 266),('type','=','out_refund'),('date_invoice','>=','2024-03-27'),('date_invoice','<=','2024-06-30'),('company_id','=',2)]
domain = [('id','in',[171974,168824,162239,161358,159514,157856,157496,151839,124830])]
