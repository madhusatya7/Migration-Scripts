...
account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('type','!=','out_refund'),('state','not in',['draft','cancel']),('create_date','>=','2025-01-01 00:00:00'),('date_invoice','>=','2024-04-01'),('date_invoice','<=','2024-12-31'),('company_id','=',2),('journal_id','=',266)]],{'order': 'id DESC'})
...
####################
#account_invoice = account_invoice[800:]
