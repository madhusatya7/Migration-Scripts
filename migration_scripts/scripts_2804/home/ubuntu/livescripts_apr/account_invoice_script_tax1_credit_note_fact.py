...
account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('journal_id','in',[10,262]),('type','=','out_refund'),('state','not in',['draft','cancel']),('create_date','>=','2025-01-01 00:00:00'),('date_invoice','>=','2024-01-01'),('date_invoice','<=','2024-12-31'),('company_id','=',2)]],{'order': 'id DESC'})
# account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('date_invoice','>=','2024-01-01'),('company_id','=',5)]],{'order': 'id DESC'})
