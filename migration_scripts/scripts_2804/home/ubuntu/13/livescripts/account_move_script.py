...
domain = [('date','>=','2025-01-01'),('date','<=','2025-02-17'),('state','in',['posted']),('company_id','=',15),('journal_id','not in', ej_119)]
...
##############################
#account_move = account_move[3200:]
#account_move = account_move[6200:]
