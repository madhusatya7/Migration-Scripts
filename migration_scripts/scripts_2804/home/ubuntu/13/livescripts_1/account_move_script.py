...
domain = [('date','>=','2024-07-01'),('date','<=','2024-12-31'),('state','in',['posted']),('company_id','=',15),('journal_id','not in', ej_119)]
...
##############################
account_move = account_move[3300:]
account_move = account_move[6100:]
