...
def get_cogs_price_updates(v18_rec,v12_rec,cogs_mapped_idv18,stock_outputv18,cogs_mapped_idv12,stock_outputv12,acc_recvbl18,acc_recbl12,acc_payble18,acc_payble12,p_id18,p_id12,amlv12,vansal_tax_act12,vansal_tax_act18,rpl_tax,c):
    ...
    print("counter >>>>>>>>>>>>>",c,rec18_stock)
    # aml_id2 = ac_recv12_stock[c]['id']
...
#domain = [('id','in',[178471,178467])]


#domain = [('journal_id','=', 266),('type','=','out_refund'),('date_invoice','>=','2025-04-09'),('date_invoice','<=','2025-04-20'),('company_id','=',2)]


domain = [('journal_id','=', 266),('type','=','out_refund'),('create_date','>=','2025-04-01 00:00:00'),('company_id','=',2)]
...
####################
#account_invoice = account_invoice[190:]
