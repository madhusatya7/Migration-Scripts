##########this branches having service products also#############
...
#domain = [('id','in',[176366])]
domain = [('state','not in',['draft','cancel']),('journal_id','=',18),('type','=','out_invoice'),('date_invoice','>=','2025-01-01'),('date_invoice','<=','2025-02-16'),('company_id','=',3)]
...
####################
#account_invoice = account_invoice[40:]
#account_invoice = account_invoice[560:]
#account_invoice = account_invoice[80:]
    ...
    for rec in range(0,len(account_invoice)):
        ...
        if not rec_is_exitst:
            ...
            if state18 in ['open','in_payment','paid']:
                ...
                cogs_mapped_idv18 = 4424 #v18
                stock_outputv18 = 4512 #v18
                acc_recvbl18 = 581
                acc_payble18 = 516
                vansal_tax_act18 = 742 # taxreceivable

                cogs_mapped_idv12 = 478 #direct v12
                stock_outputv12 = 5860 # direct v12
                acc_recbl12 = 378 #direct v12
                acc_payble12 = 428
                
                vansal_tax_act12 = 428

                rpl_tax = 428 # Tota sale account to chaged because details chaged,Modification applied
                ...
                #     if count >= 2:
                #         # print("\n\n\n\n>>>santise>>",pair,cogs_mapped_idv18,stock_outputv18),
