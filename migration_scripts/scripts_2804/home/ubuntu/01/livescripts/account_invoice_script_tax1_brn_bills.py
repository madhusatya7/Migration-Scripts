...
# domain = [('journal_id','=',19),('state','not in',['draft','cancel']),('company_id','=',3),('date_invoice','>=','2025-01-01'),('date_invoice','<=','2025-02-17')]
...
####################
#account_invoice = account_invoice[1700:]
#account_invoice = account_invoice[910:]
