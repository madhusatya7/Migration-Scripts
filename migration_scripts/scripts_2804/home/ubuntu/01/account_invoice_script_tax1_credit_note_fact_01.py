...
domain =[('journal_id','=',18),('type','=','out_refund'),('state','not in',['draft','cancel']),('date_invoice','>=','2025-01-01'),('date_invoice','<=','2025-02-16'),('company_id','=',3)]
account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [domain],{'order': 'id DESC'})
# account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('journal_id','in',[10,262]),('type','=','out_refund'),('state','not in',['draft','cancel']),('date_invoice','>=','2024-03-01'),('date_invoice','<=','2024-03-31'),('company_id','=',2)]],{'order': 'id DESC'})
# account_invoice = sock.execute_kw(dbname, uid, pwd, 'account.invoice', 'search', [[('date_invoice','>=','2024-01-01'),('company_id','=',5)]],{'order': 'id DESC'})
...
####################
#account_invoice = account_invoice[25:]
#account_invoice = account_invoice[170:]
